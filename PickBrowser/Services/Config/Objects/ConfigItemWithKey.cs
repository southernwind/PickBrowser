...
namespace PickBrowser.Services.Config.Objects {
	...
	public class ConfigItemWithKey<TKey, T> : IConfigItem<ConcurrentDictionary<TKey, T>>
		where TKey : notnull {
		/// <summary>
		/// デフォルト値生成関数
		/// </summary>
		...
		public ConfigItemWithKey(IEnumerable<KeyValuePair<TKey, T>> defaultValue, T elementDefaultValue) {
